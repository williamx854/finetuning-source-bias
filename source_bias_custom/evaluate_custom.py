...
parser.add_argument(
        "--test_dataset", type=str, choices=["scifact",'nq320k'], help="The dataset test on", default="scifact")
parser.add_argument(
...
parser.add_argument('--model_name_or_path', type=str, default="contriever-base-msmarco",help="Path to your finetuned Contriever model directory or its name on Hugging Face Model Hub")
...
model = DRES(models.SentenceBERT(args.model_name_or_path), batch_size=args.batch_size, corpus_chunk_size=args.batch_size*9999)
